...
export default defineConfig({
  ...
  entry: [
    ...
    'src/cli/bin.ts',
    'src/cmmc2/index.ts',
    'src/cmmc2/aws-certificatemanager/index.ts',
    'src/cmmc2/aws-cloudtrail/index.ts',
    'src/cmmc2/aws-config/index.ts',
    ...
    'src/cmmc2/aws-guardduty/index.ts',
    ...
    'src/cmmc2/aws-securityhub/index.ts',
    'src/cmmc2/aws-sns/index.ts',
    'src/cmmc2/aws-sqs/index.ts',
    'src/cmmc2/aws-wafv2/index.ts',
